...
Download remove-wazuh-agent.sh uit de map: Uninstall en sudo chmod +x het script. (execute rechten)
...
#### Juice Shop
Stap 1:
Download remove-juiceshop.sh uit de map: Uninstall en sudo chmod +x het script. (execute rechten)
